          ...
          <tr>
            ...
            <td>
             ...
             @elseif($order->status == "PROCESS")
               ...
               <span
class="badge
bg-info text-light">{{$order->status}}
</span>
             ...
             @elseif($order->status == "FINISH")
               ...
               <span
class="badge
bg-success text-light">{{$order->status}}</span>
             ...
             @elseif($order->status == "CANCEL")
               ...
               <span
class="badge
bg-dark text-light">{{$order->status}}
</span>
...
pc (s)</td>
           ...
           <td>
            ...
            <a href="{{route('orders.edit', ['id' => $order->id])}}" class="btn btninfo
                btn-sm">
                Edit</a>
